-- ORDER BY --
-- ORDER BY cümleciği bir SORGU deyimi içerisinde
--belli ibr SUTUN'a göre
...
--kisiler tablosunu adres'e göre siralayarak sorgulayiniz
select * from kisiler order by adres

select * from kisiler order by adres ASC
--ASC ascending default olarak getirdiginden yazilmasini gerek yok

--kisiler tablosunu adres'e göre tersten sıralayalim
select * from kisiler order by adres DESC


--kisiler tablosunda maaşı buyukten kucuge siralayaniz
select * from kisiler order by maas desc

--ismi mine olanlari maas a göre azalan sırada siralayiniz
select * from kisiler
where isim='Mine'
order by maas desc

-- soyismi 'i Bulut olanları 
