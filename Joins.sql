...
--Toplam salary değeri 2500 üzeri olan her bir çalışan
--için salary toplamını bulun.
...
--Birden fazla çalışanı olan, 
--her bir state için çalışan toplamlarını bulun. 
...
--Her bir company için değeri 2000'den fazla olan 
--minimum salary değerlerini bulun.
...
--IBM, APPLE yada MICROSOFT olan ortak "name" 
--değerlerini bulun.
select name
from workers
where salary<2000
...
--EXCEPT Operator : Bir sorgu sonucundan başka bir sorgu
--sonucunu çıkarmak için kullanılır. Unique(tekrarsız) recordları verir.
...
-- 2) LEFT JOIN 
--my_companies table'ındaki companyler için order_id 
...
--3) RIGHT JOIN
--Orders table'ındaki company'ler için company_name, 
--company_id ve order_date değerlerini çağırın.
