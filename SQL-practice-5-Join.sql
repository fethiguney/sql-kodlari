...
--SORU2: sirketler tablosundaki tum sirketleri ve 
--bu sirketlere ait olan
--siparis_id ve siparis_tarihleri listeleyen 
--bir sorgu yaziniz.
...
--SORU3: siparisler tablosundaki tum siparis_id ve
--siparis_tarihleri ile bunlara karşılık gelen 
--sirket_isimlerini listeleyen bir sorgu yaziniz.
select A.sirket_id, A.sirket_isim, B.siparis_id, B.siparis_tarihi
from sirketler as A
